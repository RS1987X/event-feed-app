...
L1_CATEGORIES: List[Tuple[str, str, str]] = [
    ...
    ("admission_delisting", "Delisting / Trading halt",
     ...
     ("rd_clinical_update", "R&D / Clinical & Scientific update",
     "Clinical/pre-clinical and scientific communications: study/trial initiations & milestones (FPI/LPI, enrollment), topline/readout results, conference abstracts/posters/orals, publications, preclinical findings."),
